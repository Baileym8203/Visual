...
const Home = () => {
  ...
  return (
    <Container>
      ...
      <Col className="col-return-box">
        <h1 className="ul-code-header">HTML tag Ul</h1>
        <h3 className="ul-code">{ulHTML}</h3>
      </Col>
      <Col className="col-return-box">
        <h1 className="ol-code-header">HTML tag Ol</h1>
        <h3 className="ol-code">{olHTML}</h3>
      </Col>
      <Col className="col-return-box">
        <h1 className="li-code-header">HTML tag Li</h1>
        <h3 className="li-code">{liHTML}</h3>
      </Col>
      <Col className="col-return-box">
        <h1 className="nav-code-header">HTML tag Nav</h1>
        <h3 className="nav-code">{navHTML}</h3>
      </Col>
      <Col className="col-return-box">
        <h1 className="span-code-header">HTML tag Span</h1>
        <h3 className="span-code">{spanHTML}</h3>
      </Col>
      <Col className="col-return-box">
        <h1 className="audio-code-header">HTML tag Audio</h1>
        <h3 className="audio-code">{audioHTML}</h3>
      </Col>
      <Col className="col-return-box">
        <h1 className="video-code-header">HTML tag Video</h1>
        <h3 className="video-code">{videoHTML}</h3>
      </Col>
      <Col className="col-return-box">
        <h1 className="article-code-header">HTML tag Article</h1>
        <h3 className="article-code">{articleHTML}</h3>
      </Col>
      <Col className="col-return-box">
        <h1 className="header-code-header">HTML tag Header</h1>
        <h3 className="header-code">{headerHTML}</h3>
      </Col>
      <Col className="col-return-box">
        <h1 className="footer-code-header">HTML tag Footer</h1>
        <h3 className="footer-code">{footerHTML}</h3>
      </Col>
      <Col className="col-return-box">
        <h1 className="canvas-code-header">HTML tag Canvas</h1>
        <h3 className="canvas-code">{canvasHTML}</h3>
      </Col>
      <Col className="col-return-box">
        <h1 className="aside-code-header">HTML tag Aside</h1>
